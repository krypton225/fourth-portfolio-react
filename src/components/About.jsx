    ...
    return (
        <section id="about" className="w-screen py-40 relative bg-[#222] flex justify-center items-center">
            <div className="container grid place-content-center grid-cols-1 lg:grid-cols-2 gap-14 lg:gap-0 items-start">
                <div className="w-full h-full px-4 text-center lg:text-start relative flex flex-col justify-center" data-aos="fade-right">
                ...
                <div className="w-[50%] sm:w-[55%] lg:w-[60%] mx-auto rounded-full flex justify-center items-center" data-aos="fade-left">
